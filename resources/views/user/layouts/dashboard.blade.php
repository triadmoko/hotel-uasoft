                    ...
                    <div class="notification-item">
                        <a href="user-dashboard-profile.html" class="dropdown-item">
                            <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm flex-shrink-0 mr-2"><img src="/user-asset/images/team7.jpg" alt="team-img"></div>
...
<script src="/user-asset/js/chart.js"></script>
<script src="/user-asset/js/chart.extension.js"></script>
<script src="/user-asset/js/bar-chart.js"></script>
