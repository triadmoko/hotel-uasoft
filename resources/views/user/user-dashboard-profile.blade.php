...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/user-dashboard-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jan 2022 03:49:49 GMT -->
<head>
    ...
    <div class="sidebar-nav-body">
        ...
        <div class="sidebar-menu-wrap">
            <ul class="sidebar-menu list-items">
                ...
                <li class="page-active"><a href="user-dashboard-profile.html"><i class="la la-user mr-2"></i>My Profile</a></li>
                        ...
                        <div class="form-box">
                            ...
                            <div class="form-content">
                                ...
                                <div class="btn-box mt-4">
                                    <a href="user-dashboard-settings.html" class="theme-btn">Edit Profile</a>
                                </div>
                            </div>
                        </div><!-- end form-box -->
                    </div><!-- end col-lg-12 -->
