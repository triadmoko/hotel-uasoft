...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/add-tour.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jan 2022 03:47:23 GMT -->
<head>
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content text-center">
                        <div class="section-heading">
                            <h2 class="sec__title text-white">List your activities with the world's <br>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 mx-auto">
                ...
                <div class="form-box">
                    <div class="form-title-wrap">
                        <h3 class="title"><i class="la la-gear mr-2 text-gray"></i>Listing information for your activities</h3>
                    </div><!-- form-title-wrap -->
                    <div class="form-content contact-form-action">
                        <form method="post" class="row">
                            <div class="col-lg-6 responsive-column">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="text" placeholder="Enter place name">
                                    </div>
                                </div>
                            </div><!-- end col-lg-6 -->
                            <div class="col-lg-6 responsive-column">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <span class="la la-briefcase form-icon"></span>
                                        <input class="form-control" type="text" name="text" placeholder="Enter category name">
                                    </div>
                                </div>
                            </div><!-- end col-lg-6 -->
                            <div class="col-lg-6 responsive-column">
                            ...
                            <div class="col-lg-12">
                                <div class="input-box">
                                    <label class="label-text mb-0 line-height-20">Description of your activities</label>
                ...
                <div class="form-box">
                    <div class="form-title-wrap">
                        <h3 class="title"><i class="la la-clock mr-2 text-gray"></i>Information about your activities's open hours</h3>
                    </div><!-- form-title-wrap -->
                    <div class="form-content contact-form-action">
                        <form method="post" class="row">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <a href="javascript:void(0)" class="recommended-tag theme-btn theme-btn-small theme-btn-gray font-weight-regular mr-2">&lt; 1 hour</a>
                                <a href="javascript:void(0)" class="recommended-tag theme-btn theme-btn-small theme-btn-gray font-weight-regular mr-2">1-2 hours</a>
                                <a href="javascript:void(0)" class="recommended-tag theme-btn theme-btn-small theme-btn-gray font-weight-regular mr-2">2-3 hours</a>
                                <a href="javascript:void(0)" class="recommended-tag theme-btn theme-btn-small theme-btn-gray font-weight-regular mr-2">More than 3 hours</a>
                            </div>
                        </form>
                    </div><!-- end form-content -->
                </div><!-- end form-box -->
                        ...
                        <form method="post" class="row">
                            <div class="col-lg-12">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <span class="la la-briefcase form-icon"></span>
                                        <input class="form-control" type="text" name="text" placeholder="Itinerary name example: day 1 linfen...">
                                    </div>
                                </div>
                            </div><!-- end col-lg-12 -->
                            <div class="col-lg-12">
