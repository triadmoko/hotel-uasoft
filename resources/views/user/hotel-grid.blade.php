                    ...
                    <div class="search-result-content">
                        ...
                        <div class="search-fields-container margin-top-30px">
                            <div class="contact-form-action">
                                <form action="/hotel-grid" class="row">
                                    <div class="col-lg-10 col-sm-4 pr-0">
                                        <div class="input-box">
                                            <label class="label-text">Search Hotel or Name Hotel</label>
                                            <div class="form-group">
                                                <span class="la la-map-marker form-icon"></span>
                                                <input class="form-control" name="search" type="text"
                                                    placeholder="Destination" value="{{ request('search') }}">
                                            </div>
                                        </div>
                                    </div>
...
<section class="card-area section--padding">
    <div class="container">
                ...
                <div class="card-item">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-price d-flex align-items-center justify-content-between">
                            <p>
                                <span class="price__from">Start Price</span>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="btn-box mt-3 text-center">
                    <button type="button" class="theme-btn"><i class="la la-refresh mr-1"></i>Not Found</button>
                </div><!-- end btn-box -->
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
    </div><!-- end container -->
            ...
            <div class="col-lg-3 responsive-column">
                <div class="footer-item">
                    <div class="footer-logo padding-bottom-30px">
                        <a href="index-2.html" class="foot__logo"><img src="/user-asset/images/logo.png" alt="logo"></a>
                    </div><!-- end logo -->
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5">
                <div class="copy-right-content d-flex align-items-center justify-content-end padding-top-30px">
                    ...
                    <img src="/user-asset/images/payment-img.png" alt="">
