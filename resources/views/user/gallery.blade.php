...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jan 2022 03:48:58 GMT -->
<head>
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content text-center">
                        <div class="section-heading">
                            <h2 class="sec__title text-white">Discover Trizen's Luxury Living</h2>
                        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading text-center">
                    ...
                    <p class="sec__desc pt-2">We used bootstrap grid layout format You can change grid format from 2 to 5 responsive-columns</p>
...
<section class="gallery-area section-padding">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading text-center">
                    ...
                    <p class="sec__desc pt-2">We used owl-carousel You can change grid format from 2 to 5 responsive-columns</p>
                </div><!-- end section-heading -->
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
    </div><!-- end container -->
    <div class="full-width-slider padding-top-50px carousel-action">
        <div class="full-width-slide-item">
            <a class="d-block" data-fancybox="gallery" href="images/img30.jpg" data-caption="Showing image 1">
                <img src="images/img30.jpg">
            </a>
        </div><!-- end full-width-slide-item -->
        <div class="full-width-slide-item">
            <a class="d-block" data-fancybox="gallery" href="images/img31.jpg" data-caption="Showing image 2">
                <img src="images/img31.jpg">
            </a>
        </div><!-- end full-width-slide-item -->
        <div class="full-width-slide-item">
            <a class="d-block" data-fancybox="gallery" href="images/img32.jpg" data-caption="Showing image 3">
                <img src="images/img32.jpg">
            </a>
        </div><!-- end full-width-slide-item -->
        <div class="full-width-slide-item">
            <a class="d-block" data-fancybox="gallery" href="images/img33.jpg" data-caption="Showing image 4">
                <img src="images/img33.jpg">
            </a>
        </div><!-- end full-width-slide-item -->
        <div class="full-width-slide-item">
            <a class="d-block" data-fancybox="gallery" href="images/img34.jpg" data-caption="Showing image 5">
                <img src="images/img34.jpg">
            </a>
        </div><!-- end full-width-slide-item -->
...
<script src="js/masonry-4.2.2.min.js"></script>
<script src="js/main.js"></script>
</body>

<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jan 2022 03:49:09 GMT -->
</html>