...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/hotel-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jan 2022 03:49:32 GMT -->
<head>
                ...
                <div class="col-lg-6">
                    <div class="breadcrumb-content">
                        <div class="section-heading">
                            <h2 class="sec__title text-white">Hotel Sidebar</h2>
                        </div>
                ...
                <div class="filter-wrap margin-bottom-30px">
                    <div class="filter-top d-flex align-items-center justify-content-between pb-4">
                        ...
                        <div class="layout-view d-flex align-items-center">
                            <a href="hotel-grid.html" data-toggle="tooltip" data-placement="top" title="Grid View" class="active"><i class="la la-th-large"></i></a>
                            <a href="hotel-list.html" data-toggle="tooltip" data-placement="top" title="List View"><i class="la la-th-list"></i></a>
                        </div>
                    </div><!-- end filter-top -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 responsive-column">
                        <div class="card-item">
                            ...
                            <div class="card-body">
                                <h3 class="card-title"><a href="hotel-single.html">EnVision Hotel Boston</a></h3>
                                <p class="card-meta"> Boston, MA, USA</p>
                                <div class="card-rating">
                                    <span class="badge text-white">4.4/5</span>
                                    <span class="review__text">Average</span>
                                    <span class="rating__text">(30 Reviews)</span>
                    ...
                    <div class="col-lg-6 responsive-column">
                        <div class="card-item">
                            ...
                            <div class="card-body">
                                <h3 class="card-title"><a href="hotel-single.html">Parian Holiday Villas</a></h3>
                                <p class="card-meta">Virginia, USA</p>
                                <div class="card-rating">
                                    <span class="badge text-white">4.4/5</span>
                                    <span class="review__text">Average</span>
                                    <span class="rating__text">(30 Reviews)</span>
