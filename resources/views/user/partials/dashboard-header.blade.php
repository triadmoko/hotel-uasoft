            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="menu-wrapper">
                        <div class="logo mr-5">
                            <a href="/"><img src="/user-asset/images/logo2.png" alt="logo"></a>
                                        ...
                                        <a href="#" class="dropdown-toggle" id="userDropdownMenu" data-toggle="dropdown"
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-sm flex-shrink-0 mr-2"><img
                                                        src="/user-asset/images/team8.jpg" alt="team-img"></div>
                                                <span
                                        ...
                                        <div class="dropdown-menu dropdown-reveal dropdown-menu-md dropdown-menu-right">
                                            ...
                                            <div class="list-group drop-reveal-list user-drop-reveal-list">
                                                <a href="user-dashboard-profile.html"
                                                    ...
                                                    <div class="msg-body">
                                                        <div class="msg-content">
                                                            <h3 class="title"><i class="la la-user mr-2"></i>My Profile
                                                            </h3>
                                                        </div>
                                                    </div><!-- end msg-body -->
                                                </a>
                                                ...
                                                <a href="user-dashboard-reviews.html"
                                                    ...
                                                    <div class="msg-body">
                                                        <div class="msg-content">
                                                            <h3 class="title"><i class="la la-heart mr-2"></i>My Reviews
                                                            </h3>
                                                        </div>
                                                    </div><!-- end msg-body -->
                                                </a>
