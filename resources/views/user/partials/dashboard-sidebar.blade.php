    ...
    <div class="sidebar-nav-body">
        ...
        <div class="sidebar-menu-wrap">
            <ul class="sidebar-menu list-items">
                <li class="{{ Request::is('user-dashboard')? 'page-active' : '' }}"><a href="/user-dashboard"><i class="la la-dashboard mr-2"></i>Dashboard</a></li>
                <li class="{{ Request::is('user-dashboard/hotel')? 'page-active' : '' }}"><a href="/user-dashboard/hotel"><i class="la la-shopping-cart mr-2 text-color"></i>My Booking</a></li>
