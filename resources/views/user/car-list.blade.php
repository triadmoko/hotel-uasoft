...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/car-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jan 2022 03:49:34 GMT -->
<head>
                ...
                <div class="filter-wrap margin-bottom-30px">
                    <div class="filter-top d-flex align-items-center justify-content-between pb-4">
                        <div>
                            ...
                            <p class="font-size-14"><span class="mr-1 pt-1">Book with confidence:</span>No car booking fees</p>
                        </div>
                        <div class="layout-view d-flex align-items-center">
                            <a href="car-grid.html" data-toggle="tooltip" data-placement="top" title="Grid View"><i class="la la-th-large"></i></a>
                            <a href="car-list.html" data-toggle="tooltip" data-placement="top" title="List View" class="active"><i class="la la-th-list"></i></a>
                        </div>
                    </div><!-- end filter-top -->
