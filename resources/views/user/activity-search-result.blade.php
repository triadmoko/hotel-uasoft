...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/activity-search-result.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jan 2022 03:49:40 GMT -->
<head>
                ...
                <div class="col-lg-12">
                    <div class="search-result-content">
                        <div class="section-heading">
                            <h2 class="sec__title text-white">Activity Search Result</h2>
                        </div>
                                ...
                                <div class="pt-3 collapse" id="collapseTwo">
                                    ...
                                    <div class="checkbox-wrap padding-top-30px">
                                        ...
                                        <div class="custom-checkbox d-inline-block mr-4">
                                            ...
                                            <label for="activityChb4">Workshops</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-12">
                <div class="filter-wrap margin-bottom-30px">
                    <div class="filter-top pb-4">
                        <h3 class="title font-size-24">San Francisco: 20 activities found</h3>
                    ...
                    <div class="filter-bar d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="dropdown-item">
                                            <div class="checkbox-wrap">
                                                ...
                                                <div class="custom-checkbox">
                                                    ...
                                                    <label for="catChb3">Sightseeing Tours</label>
                                                </div>
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" id="catChb4">
                                                    <label for="catChb4">Workshops</label>
                                                </div>
                                            </div>
                                        </div><!-- end dropdown-item -->
                                    </div><!-- end dropdown-menu -->
                        ...
                        <div class="select-contain">
                            <select class="select-contain-select">
                                ...
                                <option value="2">New Activity</option>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="btn-box mt-3 text-center">
                    ...
                    <p class="font-size-13 pt-2">Showing 1 - 6 of 44 Activities</p>
                </div><!-- end btn-box -->
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
    </div><!-- end container -->
